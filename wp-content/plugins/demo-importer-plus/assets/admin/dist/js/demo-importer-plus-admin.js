...
(function ($) {
  ...
  DemoImporterPlus = (_DemoImporterPlus = {
    ...
    _bind: function _bind() {
      ...
      $(document.body).on("click", "#demo-import-plus .demo-import-plus-previewing-site .theme-screenshot, #demo-import-plus .demo-import-plus-previewing-site .theme-name", DemoImporterPlus.show_page_popup_from_search);
      ...
      $(document).on("input keyup", ".demo-importer-plus-search ", DemoImporterPlus.searchDemo); // $(document).on(
      // 	"change",
      // 	"#demo-importer-plus-cat-search",
    ...
    searchDemo: function searchDemo(e) {
      ...
      var sites = $("#demo-importer-plus .demo-importer-plus-theme"),
          titles = $("#demo-importer-plus .demo-importer-plus-theme .theme-name"),
      ...
      items = DemoImporterPlus._get_sites_and_pages_by_search_term(search_term);
      ...
      if (!DemoImporterPlus.isEmpty(items)) {
        ...
        $("#demo-import-plus").html(wp.template("demo-importer-plus-no-sites"));
      }
    },
    ...
    _get_sites_and_pages_by_search_term: function _get_sites_and_pages_by_search_term(search_term) {
      ...
      for (site_id in demoImporterVars.default_page_builder_sites) {
        ...
        } //TODO: Remove this is page serch is not required.


        if (search_term != "") {// Check in page title.
          ...
          // 		for (filter_id in DemoImporterPlus.filter_array) {
          // 			var pslug =
          // 				DemoImporterPlus.filter_array[filter_id];
          // 			if (
          // 				pslug == "free" &&
          // 				"free" == pages[page_id]["sites-type"]
          // 			) {
          ...
          // 				undefined != pslug
          // 			) {
          // 				for (cat_id in current_site[
          // 					"site-categories"
          // 				]) {
          // 					if (
          // 						pslug.toLowerCase() ==
          // 						current_site["site-categories"][
          // 							cat_id
          // 						].slug
          // 					) {
          ...
          // 				items[page_id]["sites-type"] =
          // 					current_site["sites-type"] || "";
          // 				items[page_id]["site-title"] =
          // 					current_site["title"] || "";
          ...
          // 					)
          // 				);
          // 				for (site_tag_id in pages[page_id][
          // 					"sites-tag"
          // 				]) {
          // 					var tag_title =
          // 						pages[page_id]["sites-tag"][
          // 						site_tag_id
          // 						];
          // 					tag_title =
          // 						DemoImporterPlus._unescape_lower(
    ...
    _installError: function _installError(event, response) {
      ...
      $(".demo-import-plus-import-content").html('<p>Plugin "<b>' + response.name + '</b>" installation failed.</p><p>There has been an error on your website. Read an article <a href="https://wpdip.com/docs/starter-templates-plugin-installation-failed/" target="blank">here</a> to solve the issue.</p>');
      $(".dip-demo-import").removeClass("updating-message installing button-primary").addClass("disabled").text("Import Failed!");
      wp.updates.queue = [];
