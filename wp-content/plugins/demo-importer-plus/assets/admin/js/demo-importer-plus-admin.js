...
(function ($) {
	...
	DemoImporterPlus = {
		...
		_bind: () => {
			...
			$(document.body).on(
				"click",
				"#demo-import-plus .demo-import-plus-previewing-site .theme-screenshot, #demo-import-plus .demo-import-plus-previewing-site .theme-name",
		...
		_installError: function (event, response) {
			...
			$(".demo-import-plus-import-content").html(
				'<p>Plugin "<b>' +
				response.name +
				'</b>" installation failed.</p><p>There has been an error on your website. Read an article <a href="https://wpdip.com/docs/starter-templates-plugin-installation-failed/" target="blank">here</a> to solve the issue.</p>'
			);
